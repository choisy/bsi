...
[here](https://raw.githubusercontent.com/choisy/bsi/master/another_shot.Rmd).
You can download this R markdown file directly from R as so:

```{r eval = FALSE}
download.file("https://raw.githubusercontent.com/choisy/bsi/master/another_shot.Rmd", "bsi_analysis.Rmd")
```
