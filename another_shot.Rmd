...
data2 %>% 
  select(PatientNo, hospital, Sex, age, otherhosp, NKQ, tracheostomy, apache,
         ...
         dia_co, Mode, rand2icu, rand2hos, adm2icu, adm2hos, had_catheter, nb_cl_days, had_arterial, nb_al_days, deathICUdis, deathHOSdis, death28days, death90days,
  ...
  sstable.baseline(hospital + Sex + age + otherhosp + NKQ + tracheostomy + apache +
                   ...
                   Myo + otherpath + dia_co + Mode + rand2icu + rand2hos + adm2icu +
                   adm2hos + had_catheter + nb_cl_days + had_arterial + nb_al_days +
                   deathICUdis + deathHOSdis + death28days + death90days ~ habsi,
...
```{r}
patient_day(habsi, rand2icu, data2)
patient_day(habsi, rand2hos, data2)
patient_day(habsi, nb_cl_days, data2)
patient_day(habsi, nb_al_days, data2)
day_per_patient(habsi, nb_cl_days, data2)
day_per_patient(habsi, nb_al_days, data2)
```
