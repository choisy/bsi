...
```{r fig.width = 8}
pie(path_freq[c(1:7, 9:8, 10:18)], cex = 2 / 3, col = colors[names(path_freq[c(1:7, 9:8, 10:18)])])
```

First BSI episodes:

```{r fig.width = 8}
pie(path_freq_1step, cex = 2 / 3, col = colors[names(path_freq_1step)])
```

CLBSI (first) episodes:

```{r fig.width = 8}
pie(path_freq_1stCLBSI[c(1:5, 8, 6:7, 9:13)], cex = 2 / 3, col = colors[names(path_freq_1stCLBSI[c(1:5, 8, 6:7, 9:13)])])
```

ALBSI (first) episodes:

```{r fig.width = 8}
pie(path_freq_1stALBSI[c(1:6, 11:12, 7:10, 13:14)], cex = 2 / 3, col = colors[names(path_freq_1stALBSI[c(1:6, 11:12, 7:10, 13:14)])])
```

Non-CLBSI (first) episodes:

```{r fig.width = 8}
pie(path_freq_nonCLBSI[c(1:6, 9, 7:8, 10)], cex = 2 / 3, col = colors[names(path_freq_nonCLBSI[c(1:6, 9, 7:8, 10)])])
```
