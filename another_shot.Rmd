...
data2 %<>% 
  select(PatientNo, hospital, Sex, age, otherhosp, NKQ, tracheostomy,
         ...
         adm2hos, had_catheter, nb_cl_days, had_arterial, nb_al_days, habsi,
         habsi_risk, CLBSI_risk, CLBSI, ALBSI_risk, ALBSI, death28, death90, deathICU,
...
```{r}
cbind(numbers, or_uni, p_uni, or_multi, p_multi) %>%
  as.data.frame(stringsAsFactors = FALSE)
```
