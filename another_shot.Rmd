...
```{r}
data$FU %<>% select(PatientNo, DeathDate28, Status28, Date28) # We probably don't need this
```

and:

```{r}
data$FU_DAY90 %<>% select(PatientNo, DeathDate90, Status90, Date90) # We probably don't need this
```
...
#         ALBSI_risk, apache, charlson_cat, Tetanus, Pneumonia, sepsis, CNS, COPD,
#         CVA, Myo, otherpath, dia_co, Mode, rand2icu, rand2hos, adm2icu, adm2hos,
#         had_catheter, nb_cl_days, had_arterial, nb_al_days, habsi, deathICUdis,
#         deathHOSdis, death28days, death90days, habsi_risk, CLBSI_risk, CLBSI,
#         ALBSI_risk, ALBSI) %>% 
