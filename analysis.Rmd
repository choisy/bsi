...
[here](https://raw.githubusercontent.com/choisy/bsi/master/bsi.csv) for the
patient-based data (`data2`),
[here](https://raw.githubusercontent.com/choisy/bsi/master/micbld.csv) for the
blood microbiology data (`data$MICBLD`) and
[here](https://raw.githubusercontent.com/choisy/bsi/master/daily_icu.csv) for
