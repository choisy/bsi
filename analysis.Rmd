...
<!--
The Excel versions of this
data sets are available [here]() for the patient-based data (`data2`), [here]()
for the blood microbiology data (`data$MICBLD`) and [here]() for the daily ICU data (`data$DAILY1n2`).
-->

<!--
The outputted tables are available in Word format [here]() and t
-->

The figures can
simply be dragged and dropped (in PNG format) directly from this HTML document.
