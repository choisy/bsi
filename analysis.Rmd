...
[here](https://raw.githubusercontent.com/choisy/bsi/master/output/CSV/bsi.csv) for the
patient-based data (`data2`),
[here](https://raw.githubusercontent.com/choisy/bsi/master/output/CSV/micbld.csv) for the
blood microbiology data (`data$MICBLD`) and
[here](https://raw.githubusercontent.com/choisy/bsi/master/output/CSV/daily_icu.csv) for
